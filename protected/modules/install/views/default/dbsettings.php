...
<div
	class="row-fluid mysql-enable postgresql-enable control-group <?php echo $data['model']->hasErrors('host') ? 'error' : ''; ?>">
...
<div
	class="row-fluid mysql-enable postgresql-enable control-group <?php echo $data['model']->hasErrors('port') ? 'error' : ''; ?>">
...
<div
	class="row-fluid mysql-enable postgresql-enable control-group <?php echo $data['model']->hasErrors('dbName') ? 'error' : ''; ?>">
...
<div
	class="row-fluid mysql-enable postgresql-enable control-group <?php echo $data['model']->hasErrors('createDb') ? 'error' : ''; ?>">
	<?php echo $form->checkBoxRow($data['model'], 'createDb'); ?>
</div>

<div
	class="row-fluid mysql-enable postgresql-enable control-group <?php echo $data['model']->hasErrors('tablePrefix') ? 'error' : ''; ?>">
...
<div
	class="row-fluid mysql-enable postgresql-enable control-group <?php echo $data['model']->hasErrors('dbUser') ? 'error' : ''; ?>">
...
<div
	class="row-fluid mysql-enable postgresql-enable control-group <?php echo $data['model']->hasErrors('dbPassword') ? 'error' : ''; ?>">
...
<div
	class="row-fluid mysql-enable postgresql-enable control-group <?php echo $data['model']->hasErrors('socket') ? 'error' : ''; ?>">
