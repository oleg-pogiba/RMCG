...
<div
	class="wide row-fluid control-group <?php echo ($model->hasErrors('menu_id') || $model->hasErrors('parent_id')) ? 'error' : ''; ?>">
	<?php
...
<div class="accordion-group">
	...
	<div id="collapseOne" class="accordion-body collapse">
		<div class="accordion-inner">
			...
			<div
				class="wide row-fluid control-group <?php echo ($model->hasErrors('before_link') || $model->hasErrors('after_link')) ? 'error' : ''; ?>">
				<div class="span3">
			...
			<div
				class="wide row-fluid control-group <?php echo ($model->hasErrors('target') || $model->hasErrors('rel')) ? 'error' : ''; ?>">
				<div class="span3">
			...
			<div
				class="wide row-fluid control-group <?php echo ($model->hasErrors('condition_name') || $model->hasErrors('condition_denial')) ? 'error' : ''; ?>">
				<div class="span4">
