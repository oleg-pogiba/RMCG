...
(function () {
    ...
    CKEDITOR.env || (CKEDITOR.env = function () {
        ...
        if (a.gecko)if (e <
            10900)a.cssClass = a.cssClass + " cke_browser_gecko18"; else if (e <= 11E3)a.cssClass = a.cssClass + " cke_browser_gecko19";
    ...
    (function () {
        ...
        CKEDITOR.tools = {arrayCompare: function (a, e) {
            ...
            if (typeof(f = arguments[b - 1]) == "boolean")b--; else if (typeof(f = arguments[b - 2]) == "boolean") {
                d = arguments[b - 1];
                b = b - 2
            }
            for (var c = 1; c < b; c++) {
                var l = arguments[c], j;
                for (j in l)if (f === true || a[j] == void 0)if (!d ||
                    j in d)a[j] = l[j]
            }
            return a
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {appendTo: function (b, c) {
        ...
        do if (!b || !(c != this.$ && c.nodeType == CKEDITOR.NODE_TEXT && (e || !c.nodeValue))) {
            a++;
            e = c.nodeType == CKEDITOR.NODE_TEXT
        } while (c = c.previousSibling);
        return a
    }, getNextSourceNode: function (b, c, a) {
        if (a && !a.call)var e = a, a = function (a) {
            return!a.equals(e)
        };
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {type: CKEDITOR.NODE_ELEMENT, addClass: function (a) {
            ...
            hasAttributes: CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) ? function () {
                ...
                if (!b.removeProperty && (a == "border" || a == "margin" || a == "padding")) {
                    ...
                    for (var b = [], i = 0; i < c.length; i++)if (d)for (var l = 0; l < d.length; l++)b.push([a, c[i], d[l]].join("-")); else b.push([a, c[i]].join("-"));
            ...
            copyAttributes: function (a, b) {
                for (var c = this.$.attributes, b = b || {}, d = 0; d < c.length; d++) {
                    ...
                    if (!(l in b))if (l == "checked" && (j = this.getAttribute(l)))a.setAttribute(l, j); else if (i.specified || CKEDITOR.env.ie && i.nodeValue && l == "value") {
    ...
    (function () {
        function b(a, b) {
            ...
            if (this.current)d = this.current[e](false, u, h); else {
                if (a)d.type ==
                    CKEDITOR.NODE_ELEMENT && (d = p > 0 ? d.getChild(p - 1) : h(d, true) === false ? null : d.getPreviousSourceNode(true, u, h)); else {
                    d = n;
    ...
    (function () {
        ...
        var e = function (a) {
            ...
            if (g.type == CKEDITOR.NODE_TEXT) {
                ...
                i = true
            } else g = g.getChild(e).getPrevious(); else {
            ...
            for (var m = c, r, A, v, o = l; o < e.length; o++) {
                ...
                for (r = r.getNext(); r;) {
                    ...
                    v = r.getNext();
                    if (b == 2)m.append(r.clone(true)); else {
                        r.remove();
                        b == 1 && m.append(r)
                    }
                    r = v
            ...
            for (c = l; c < k.length; c++) {
                ...
                if (!e[c] || r.$.parentNode != e[c].$.parentNode)for (r = r.getPrevious(); r;) {
                    ...
                    v = r.getPrevious();
                    if (b == 2)m.$.insertBefore(r.$.cloneNode(true), m.$.firstChild); else {
                        r.remove();
        ...
        CKEDITOR.dom.range.prototype = {clone: function () {
            ...
            if (b.type == CKEDITOR.NODE_ELEMENT) {
                g = b.getChildCount();
                if (g > h)b = b.getChild(h).getPreviousSourceNode(true); else if (g < 1)b = b.getPreviousSourceNode();
                else {
                        ...
                        for (; i;) {
                            ...
                            if (i.type == CKEDITOR.NODE_COMMENT)i = i.getPrevious(); else {
                                if (i.type == CKEDITOR.NODE_TEXT) {
                                    ...
                                    s =
                                        i.getText();
                                    if (/[^\s\ufeff]/.test(s))i = null; else for (var m = i.$.getElementsByTagName("*"), r = 0, A; A = m[r++];)if (!CKEDITOR.dtd.$removeEmpty[A.nodeName.toLowerCase()]) {
                                        i = null;
                                        break
                                    }
                                    i && (j = !!s.length)
            ...
            if (!this.collapsed) {
                ...
                if (g && g.type == CKEDITOR.NODE_TEXT)if (i)if (i >= g.getLength())d.setStartAfter(g); else {
                    d.setStartBefore(g);
                    f = 0
                } else d.setStartBefore(g);
                if (e && e.type == CKEDITOR.NODE_TEXT)if (k)if (k >= e.getLength())d.setEndAfter(e); else {
                    d.setEndAfter(e);
                    j = 0
    ...
    (function () {
        ...
        b.prototype = {getNextParagraph: function (b) {
            ...
            for (this._.nextNode = null; h;) {
                ...
                if (w)h.type == CKEDITOR.NODE_TEXT && a.test(h.getText()) && (w = 0); else {
                    var t = h.getName();
                    if (h.isBlockBoundary(this.forceBrBreak && !u && {br: 1})) {
                        if (t == "br")w = 1; else if (!j && !h.getChildCount() && t != "hr") {
                            f = h;
                            m = h.equals(n);
                            break
                        }
            ...
            if (!f) {
                ...
                g = {div: 1, th: 1, td: 1};
                f = f.block;
                if (!f && h && !this.enforceRealBlocks && g[h.getName()] && j.checkStartOfBlock() && j.checkEndOfBlock() && !h.equals(j.root))f = h; else if (!f || this.enforceRealBlocks && f.getName() == "li") {
    ...
    (function () {
        ...
        function e(a) {
            ...
            return a._.filterFunction = function (g, h, e, k, i, f, p) {
                ...
                if (h) {
                    ...
                    if (h.allClasses)s && (q["class"] = s); else {
        ...
        function g(a, b, c) {
            var d = a.name;
            if (z.$empty[d] || !a.children.length)if (d == "hr" && b == "br")a.replaceWith(p()); else {
        ...
        function w(a, b) {
            ...
            for (h in d)if (h == "class") {
                ...
                for (k = a.classes.join("|"); i =
                    c.pop();)if (k.indexOf(i) == -1)return false
        ...
        CKEDITOR.filter.prototype = {allow: function (b, c, d) {
            ...
            this._.cachedChecks = {};
            var g, h;
            if (typeof b == "string")b = i(b); else if (b instanceof
                CKEDITOR.style) {
                h = b.getDefinition();
                d = {};
                b = h.attributes;
            ...
            for (k = d.length; h < k; ++h) {
                ...
                if (f.elements === true || f.elements === null) {
                    ...
                    o = f.elements;
                    delete f.elements;
                    for (g in o)if (e[g])e[g][u ? "unshift" : "push"](f); else e[g] = [f]
                }
            }
            c.elements = e;
            ...
            CKEDITOR.plugins.load(c.split(","), function (c) {
                ...
                for (var k in c) {
                    ...
                    if (o && !a.lang[k]) {
                        ...
                        if (!i.langEntries || !i.langEntries[p])e.push(CKEDITOR.getUrl(i.path + "lang/" + p + ".js")); else {
    ...
    (function () {
        ...
        CKEDITOR.htmlParser.fragment.fromHtml = function (f, d, i) {
            ...
            h.onTagOpen = function (d, g, f, i) {
                ...
                g.isOptionalClose = i;
                if (b(g))u.push(g); else {
                    if (d == "pre")B = true; else {
                        if (d == "br" && B) {
                    ...
                    if (d == "br")w.push(g); else {
                        for (; ;) {
                            i = (f = k.name) ? CKEDITOR.dtd[f] || (k._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : e;
                            if (!g.isUnknown && !k.isUnknown && !i[d])if (k.isOptionalClose)h.onTagClose(f); else if (d in a && f in a) {
                                f = k.children;
                                (f = f[f.length - 1]) && f.name == "li" || n(f = new CKEDITOR.htmlParser.element("li"), k);
                                !g.returnPoint && (g.returnPoint = k);
                                k = f
                            } else if (d in CKEDITOR.dtd.$listItem && !p(d, f))h.onTagOpen(d == "li" ? "ul" : "dl", {}, 0, 1); else if (f in c && !p(d, f)) {
                                !g.returnPoint &&
                                (g.returnPoint = k);
                                k = k.parent
                            } else {
    ...
    (function () {
                ...
                return function (g) {
                    if (g.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        ...
                        if (o)for (k(o, 1) && f.push(o); o;) {
                            if (d(o) && (i = e(o)) && k(i))if ((q = e(i)) && !d(q))f.push(i); else {
                        ...
                        if (f = CKEDITOR.env.opera && !b || (typeof c == "function" ? c(g) !== false : c))if (!p && CKEDITOR.env.ie && g.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)f = false; else if (!p && CKEDITOR.env.ie && (document.documentMode > 7 || g.name in CKEDITOR.dtd.tr || g.name in CKEDITOR.dtd.$listItem))f = false; else {
                            f = a(g);
        ...
        var B = /(?:&nbsp;|\xa0)$/, z = "{cke_protected}", F = CKEDITOR.dtd, s = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], C = CKEDITOR.tools.extend({}, F.$blockLimit, F.$block), r = {elements: {}, attributeNames: [
            [/^on/, "data-cke-pa-on"]
        ]}, A = {elementNames: [
            [/^cke:/, ""],
            [/^\?xml:namespace$/, ""]
    ...
    (function () {
        ...
        CKEDITOR.editable = CKEDITOR.tools.createClass({base: CKEDITOR.dom.element,
            $: function (a, b) {
                ...
                if (!b) {
                    var e = /\n{2}/g;
                    if (e.test(a))var f = "<" + c + ">", k = "</" + c + ">", a = f + a.replace(e, function () {
                        return k + f
                    }) + k
                }
                a = a.replace(/\n/g, "<br>");
                ...
                for (var c = this.editor, h = c.config.enterMode,
                    ...
                    if (!j.checkReadOnly()) {
                        ...
                        m = !l && b || b.clone(1);
                        var s, C;
                        if (k)for (; (s = j.getCommonAncestor(0, 1)) && (C = CKEDITOR.dtd[s.getName()]) && (!C || !C[f]);)if (s.getName()in CKEDITOR.dtd.span)j.splitElement(s); else if (j.checkStartOfBlock() && j.checkEndOfBlock()) {
                            j.setStartBefore(s);
                            j.collapse(true);
                            s.remove()
                ...
                if (n) {
                    ...
                    if (k)if ((b = n.getNext(a)) && b.type == CKEDITOR.NODE_ELEMENT && b.is(CKEDITOR.dtd.$block))b.getDtd()["#"] ? j.moveToElementEditStart(b) : j.moveToElementEditEnd(n); else if (!b && h != CKEDITOR.ENTER_BR) {
        ...
        var n = function () {
            ...
            function c(a, d) {
                ...
                for (var i = k[i.getName()], j = 0, n = a.getChildren(), m = n.count(), l = -1, u = -1, t = 0, w = h.contains(k.$list); j < m; ++j) {
                    ...
                    if (b(h)) {
                        e = h.getName();
                        if (w && e in CKEDITOR.dtd.$list)o = o.concat(c(h, d)); else {
                            f = !!i[e];
            ...
            return function (j, l, t) {
                ...
                if (!A.checkReadOnly()) {
                    ...
                    for (; (D = b(r.startContainer) && r.startContainer.getChild(r.startOffset - 1)) && b(D) && D.isBlockBoundary() && I.contains(D);)r.moveToPosition(D, CKEDITOR.POSITION_BEFORE_END);
            ...
            var a = n ? function () {
                ...
                var b = function (b, c) {
                    ...
                    for (var f = d.children, g, i, j = b.duplicate(), l = 0, p = f.length - 1, m = -1, n, o; l <= p;) {
                        ...
                        if (n > 0)p = m - 1; else if (n < 0)l = m + 1; else {
                ...
                if (l && a.length > 1) {
                    ...
                    if (i)for (var m = 0; a[d + m + 1];) {
                        for (var n = l.document, i = 0, j = n.getById(c[m].endNode), n = n.getById(c[m +
                            ...
                            if (n.equals(j))i = 1; else if (b(j) || j.type == CKEDITOR.NODE_ELEMENT && j.isBlockBoundary())continue;
                            break
                        }
                        if (!i)break;
                        m++
    ...
    CKEDITOR.plugins.add("wsc", {requires: "dialog", init: function (a) {
        ...
        if (CKEDITOR.env.ie && 8 >= CKEDITOR.env.version)a = "dialogs/wsc_ie.js"; else if (window.postMessage) {
