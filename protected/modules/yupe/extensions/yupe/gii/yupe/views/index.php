...
<?php echo $form->textField($model, 'im', array('size' => 65)); ?>
	...
	<br/>
	<label>Творительный (Кем? Чем? горжусь
		...)</label><?php echo $form->textField($model, 'tvor', array('size' => 65)); ?>
	<br/>
	<label>Предложный (О ком? О чем? думаю о
		...)</label><?php echo $form->textField($model, 'pre', array('size' => 65)); ?>
	<br/>  <br/>
	...
	<br/>
	<label>Творительный (Кем? Чем? горжусь
		...)</label><?php echo $form->textField($model, 'mtvor', array('size' => 65)); ?>
	<br/>
