...
<div class="alert">
	<?php echo Yii::t('YupeModule.yupe', 'Feedback at <a href="mailto:team@yupe.ru">team@yupe.ru</a> or {link}', array('{link}' => CHtml::link(Yii::t('YupeModule.yupe', 'feedback form'), 'http://yupe.ru/contacts?from=help', array('target' => '_blank')))); ?>
