<html>
<head>
	<title><?php echo Yii::t('FeedbackModule.feedback', 'Reply on message {site}', array('{site}' => Yii::app()->name)); ?></title>
</head>
<body>
...
<br/>
<?php echo Yii::t('FeedbackModule.feedback', 'Truly yours {site} administration!', array('{site}' => CHtml::encode(Yii::app()->name))); ?>
</body>
</html>  