		...
		<?php foreach ($languages as $k => $v) : ?>
			<?php if ($k !== $model->lang) : ?>
				<?php if (empty($langModels[$k])) : ?>
					<a href="<?php echo $this->createUrl('/page/pageBackend/create', array('id' => $model->id, 'lang' => $k)); ?>"><i
							class="iconflags iconflags-<?php echo $k; ?>"
							title="<?php echo Yii::t('PageModule.page', 'Add translation for {lang}', array('{lang}' => $v)); ?>"></i></a>
				<?php else : ?>
					<a href="<?php echo $this->createUrl('/page/pageBackend/update', array('id' => $langModels[$k])); ?>"><i
							class="iconflags iconflags-<?php echo $k; ?>"
							title="<?php echo Yii::t('PageModule.page', 'Edit translation for {lang} language', array('{lang}' => $v)); ?>"></i></a>
				<?php endif; ?>
			<?php endif; ?>
		<?php endforeach; ?>
	<?php endif; ?>
...
<div
	class="wide row-fluid control-group <?php echo ($model->hasErrors('category_id') || $model->hasErrors('parent_id')) ? 'error' : ''; ?>">
	<div class="span4">
...
<div class="row-fluid control-group <?php echo $model->hasErrors('body') ? 'error' : ''; ?>">
	<div class="popover-help" data-original-title='<?php echo $model->getAttributeLabel('body'); ?>'
