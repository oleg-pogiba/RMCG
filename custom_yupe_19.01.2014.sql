...
--
-- Хост: 127.0.0.1
-- Время создания: Янв 19 2014 г., 15:08
...
--
-- База данных: `custom_yupe`
--
CREATE DATABASE IF NOT EXISTS `custom_yupe` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `custom_yupe`;
...
--
-- Структура таблицы `contentblock_content_block`
--

CREATE TABLE IF NOT EXISTS `contentblock_content_block` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(250) NOT NULL,
...
--
-- Дамп данных таблицы `contentblock_content_block`
--

INSERT INTO `contentblock_content_block` (`id`, `name`, `code`, `type`, `content`, `description`) VALUES
(1, 'footer', 'footer', 1, '\r\n	footer\r\n', ''),
(2, 'banner', 'banner', 1, '\r\n	banner\r\n', '');
...
--
-- Структура таблицы `feedback_feedback`
--
...
INSERT INTO `menu_menu` (`id`, `name`, `code`, `description`, `status`) VALUES
...
INSERT INTO `menu_menu_item` (`id`, `parent_id`, `menu_id`, `regular_link`, `title`, `href`, `class`, `title_attr`, `before_link`, `after_link`, `target`, `rel`, `condition_name`, `condition_denial`, `sort`, `status`) VALUES
...
(11, 0, 1, 0, 'News', '/news/news/index', '', '', '', '', '', '', '', 0, 14, 1);
...
INSERT INTO `page_page` (`id`, `category_id`, `lang`, `parent_id`, `creation_date`, `change_date`, `user_id`, `change_user_id`, `title_short`, `title`, `slug`, `body`, `keywords`, `description`, `status`, `is_protected`, `order`) VALUES
(1, NULL, 'en', NULL, '2014-01-12 16:08:58', '2014-01-12 16:09:15', 1, 1, 'Home page', 'Home page', 'home', '<p>\r\n	 Home page\r\n</p>', '', '', 1, 0, 0),
(2, NULL, 'ru', NULL, '2014-01-12 16:09:53', '2014-01-12 16:10:23', 1, 1, 'Домашняя страница', 'Домашняя страница', 'home', '<p>\r\n	  Домашняя страница\r\n</p>', '', '', 1, 0, 0),
...
INSERT INTO `user_user` (`id`, `change_date`, `first_name`, `middle_name`, `last_name`, `nick_name`, `email`, `gender`, `birth_date`, `site`, `about`, `location`, `status`, `access_level`, `last_visit`, `registration_date`, `avatar`, `hash`, `email_confirm`, `role`) VALUES
(1, '2014-01-12 16:06:17', '', '', '', 'admin_oleg', 'admin@admin.com', 0, NULL, '', '', '', 1, 1, '2014-01-19 00:56:34', '2014-01-12 16:06:17', NULL, '$2a$13$DIIauSl.21ZTFJZ9jkmlau23olp8J.qga1vmzpkThJJ.LcR4sWg6C', 1, 'user'),
(2, '2014-01-19 00:28:04', '', '', '', 'petro', 'petro@petro.com', 0, NULL, '', '', '', 1, 0, '2014-01-19 00:30:20', '2014-01-19 00:26:42', NULL, '$2a$13$UJivCf3DaUZsZ/VoOoq8Qu414Kac5jzJkYRQnNIOufsHJy2Tb2YAS', 0, 'user');
...
--
-- Ограничения внешнего ключа таблицы `feedback_feedback`
--
ALTER TABLE `feedback_feedback`
  ADD CONSTRAINT `fk_feedback_feedback_category` FOREIGN KEY (`category_id`) REFERENCES `category_category` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_feedback_feedback_answer_user` FOREIGN KEY (`answer_user`) REFERENCES `user_user` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION;

--
-- Ограничения внешнего ключа таблицы `menu_menu_item`
--
ALTER TABLE `menu_menu_item`
  ADD CONSTRAINT `fk_menu_menu_item_menu_id` FOREIGN KEY (`menu_id`) REFERENCES `menu_menu` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ограничения внешнего ключа таблицы `news_news`
--
ALTER TABLE `news_news`
  ADD CONSTRAINT `fk_news_news_category_id` FOREIGN KEY (`category_id`) REFERENCES `category_category` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_news_news_user_id` FOREIGN KEY (`user_id`) REFERENCES `user_user` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION;

--
-- Ограничения внешнего ключа таблицы `page_page`
--
ALTER TABLE `page_page`
  ADD CONSTRAINT `fk_page_page_category_id` FOREIGN KEY (`category_id`) REFERENCES `category_category` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_page_page_change_user_id` FOREIGN KEY (`change_user_id`) REFERENCES `user_user` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_page_page_user_id` FOREIGN KEY (`user_id`) REFERENCES `user_user` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION;

--
-- Ограничения внешнего ключа таблицы `user_tokens`
--
ALTER TABLE `user_tokens`
  ADD CONSTRAINT `fk_user_tokens_user_id` FOREIGN KEY (`user_id`) REFERENCES `user_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ограничения внешнего ключа таблицы `yupe_settings`
--
ALTER TABLE `yupe_settings`
  ADD CONSTRAINT `fk_yupe_settings_user_id` FOREIGN KEY (`user_id`) REFERENCES `user_user` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION;
