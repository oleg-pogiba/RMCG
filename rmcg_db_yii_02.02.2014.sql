...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 02 2014 г., 17:28
...
--
-- База данных: `rmcg_yii`
--
CREATE DATABASE IF NOT EXISTS `rmcg_yii` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `rmcg_yii`;
...
INSERT INTO `feedback` (`id`, `category_id`, `answer_user`, `creation_date`, `change_date`, `name`, `email`, `phone`, `theme`, `text`, `type`, `answer`, `answer_date`, `is_faq`, `status`, `ip`) VALUES
(1, NULL, NULL, '2014-01-29 01:26:57', '2014-01-29 01:26:57', 'admin_oleg', 'admin@admin.com', '', 'asdf', 'asdf', 0, '', NULL, 0, 0, '127.0.0.1'),
(2, NULL, NULL, '2014-01-29 01:45:48', '2014-01-29 01:45:48', 'admin_oleg', 'admin@admin.com', '', 'asdf', 'asdf', 0, '', NULL, 0, 0, '127.0.0.1'),
(3, NULL, NULL, '2014-01-29 01:47:59', '2014-01-29 01:47:59', 'sdaf', 'workposst@gmail.com', '24523452345', '34252522345', '<p>\r\n	2352345234\r\n</p>', 2, '', NULL, 0, 0, '127.0.0.1');
...
(3, 0, 1, 0, 'Пользователи', '/user/people/index', '', 'Пользователи', '', '', '', '', '', 0, 3, 1),
...
(1, NULL, 'ru', '2014-01-19 16:10:58', '2014-01-30 19:28:47', '2014-01-19', 'Тестовая новость', 'testovaja-novost', '<p>\r\n	Наказ МОЗ України "Про державну реєстрацію (перереєстрацію) лікарських засобів та внесення змін у реєстраційні матеріали" від 27 грудня 2013р №1153\r\n</p>', '<p>\r\n	Наказ МОЗ України "Про державну реєстрацію (перереєстрацію) лікарських засобів та внесення змін у реєстраційні матеріали" від 27 грудня 2013р №1153\r\n</p>', NULL, '', 1, 1, 0, '', ''),
(2, NULL, 'uk', '2014-01-19 16:12:31', '2014-01-19 16:17:19', '2014-01-19', 'Тестовая новость ukr', 'testovaja-novost', '<p>\r\n	 ukr\r\n</p>', '<p>\r\n	 ukr\r\n</p>', NULL, '', 1, 1, 0, '', ''),
(3, NULL, 'uk', '2014-01-30 19:55:13', '2014-01-30 19:55:13', '2014-01-30', 'новость 2', 'novost-2', '<p>\r\n	Наказ МОЗ України "Про державну реєстрацію (перереєстрацію) лікарських засобів та внесення змін у реєстраційні матеріали" від 27 грудня 2013р №1153\r\n</p>', '<p>\r\n	Наказ МОЗ України "Про державну реєстрацію (перереєстрацію) лікарських засобів та внесення змін у реєстраційні матеріали" від 27 грудня 2013р №1153\r\n</p>', NULL, '', 1, 1, 0, '', ''),
(4, NULL, 'ru', '2014-01-30 19:58:03', '2014-01-30 19:58:03', '2014-01-30', 'новость 2', 'novost-2', '<p>\r\n	 Наказ МОЗ України "Про державну реєстрацію (перереєстрацію) лікарських засобів та внесення змін у реєстраційні матеріали" від 27 грудня 2013р №1153\r\n</p>', '<p>\r\n	Наказ МОЗ України "Про державну реєстрацію (перереєстрацію) лікарських засобів та внесення змін у реєстраційні матеріали" від 27 грудня 2013р №1153\r\n</p>', NULL, '', 1, 1, 0, '', ''),
(5, NULL, 'ru', '2014-01-30 20:01:31', '2014-01-30 20:01:31', '2014-01-30', 'sadfasdf', 'sadfasdf', '<p>\r\n	asdfasdfasdf\r\n</p>', '<p>\r\n	sdfasdfasdf\r\n</p>', NULL, '', 1, 1, 0, '', '');
...
(2, NULL, 'ru', NULL, '2014-01-12 16:09:53', '2014-02-02 17:39:09', 1, 1, 'Домашняя страница', 'Домашняя страница', 'homecccccccc', '<p>\r\n	    Домашняя страница\r\n</p>\r\n<p>\r\n	 <img src="/public/uploads/19012014/0b29203a1c78b896b61bc1f457b1062f.jpg">\r\n</p>', '', '', 1, 0, 0),
(3, NULL, 'uk', NULL, '2014-01-12 16:11:03', '2014-02-02 17:38:55', 1, 1, 'Домашня сторiнка', 'Домашня сторiнка', 'home', '<p>\r\n	        Домашня сторiнкаccccccccc\r\n</p>', '', '', 1, 0, 0),
(4, NULL, 'ru', NULL, '2014-02-02 18:02:08', '2014-02-02 18:02:08', 1, 1, 'Фармаконадзора', 'Фармаконадзора', 'farmakonadzora', '<p>\r\n	Фармаконадзора\r\n</p>', '', '', 1, 1, 0),
(5, NULL, 'ru', NULL, '2014-02-02 18:02:44', '2014-02-02 18:02:44', 1, 1, 'Фармаконадзор', 'Фармаконадзор', 'farmakonadzor', '<h2>Фармаконадзор</h2>', '', '', 1, 1, 0);
...
(1, '2014-01-12 16:06:17', '', '', '', 'admin_oleg', 'admin@admin.com', 0, NULL, '', '', '', 1, 1, '2014-02-02 16:39:18', '2014-01-12 16:06:17', NULL, '$2a$13$DIIauSl.21ZTFJZ9jkmlau23olp8J.qga1vmzpkThJJ.LcR4sWg6C', 1, 'user'),
...
(5, 'yupe', 'theme', 'rmcg', '2014-01-12 16:06:43', '2014-01-30 19:07:52', 1, 1),
