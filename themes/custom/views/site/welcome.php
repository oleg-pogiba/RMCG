...
<P> We made some blanks for you, for example, list of posts (from "Blog" module) you can
	find <?php echo CHtml::link('here', array('/site/main')) ?> (SiteController/actionMain)</P>
