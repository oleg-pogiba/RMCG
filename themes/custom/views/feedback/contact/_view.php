<div class="accordion-group">
	<div class="accordion-heading">
		<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion<?php echo $data->id ?>"
		   href="#collapseOne<?php echo $data->id ?>">
			<?php echo YText::characterLimiter(strip_tags($data->theme), 250); ?>
		</a>
	</div>
