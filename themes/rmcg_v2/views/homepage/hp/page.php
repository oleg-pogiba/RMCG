		...
		<div id="column1">
			...
			<p>
				<?php echo CHtml::link(
					...
					Yii::app()->createUrl('page/page/show', array('slug' => 'registration'))
				);
				?>
			</p>
		</div>
		<div id="column2">
			...
			<p>
				<?php echo CHtml::link(
					...
					Yii::app()->createUrl('page/page/show', array('slug' => 'sertification'))
				);
				?>
			</p>
		</div>
		...
		<div id="column4">
			...
			<p>
				<?php echo CHtml::link(
					...
					Yii::app()->createUrl('page/page/show', array('slug' => 'marketing'))
				);
				?>
			</p>
		</div>
		<div id="column5">
			...
			<p>
				<?php echo CHtml::link(
					...
					Yii::app()->createUrl('page/page/show', array('slug' => 'pharmacovigilance'))
				);
				?>
			</p>
		</div>
