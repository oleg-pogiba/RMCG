...
?>
	...
	<div class="row-fluid">
		...
		<div class='span6'>
			...
			<i class="icon-user"></i> <?php echo CHtml::link($user->getFullName(), array('/user/people/userInfo/', 'username' => $user->nick_name)); ?>
			<br/>
			...
			<?php if ($user->site): ?>
				<i class="icon-globe"></i> <?php echo CHtml::link($user->site, $user->site, array('rel' => 'nofollow', 'target' => '_blank')); ?>
				<br/>
			<?php endif; ?>
...
<?php else: ?>
	<div class="alert alert-notice">
		<?php echo Yii::t('UserModule.user', 'Please,') . ' ';
		echo CHtml::link(Yii::t('UserModule.user', 'sign in'), array('/user/account/login/'));
		echo ' ' . Yii::t('UserModule.user', 'or') . ' '; ?>
