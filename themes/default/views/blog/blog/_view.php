<div class="row-fluid">
	...
	<div class="span7 blog-info">
		...
		<span
			class="icon-calendar"> <?php echo Yii::app()->getDateFormatter()->formatDateTime($data->create_date, "long", false); ?> </span>
		<span
			class="icon-pencil"> <?php echo CHtml::link($data->postsCount, array('/blog/post/blog/', 'slug' => $data->slug)); ?> </span>
