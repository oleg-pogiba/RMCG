<html>
<head>
	<title><?php echo Yii::t('FeedbackModule.feedback', 'Answer for your message from {site}', array('{site}' => Yii::app()->name)); ?></title>
</head>
<body>
<?php echo Yii::t('FeedbackModule.feedback', 'Answer for your message from {site}', array('{site}' => Yii::app()->name)); ?>
<br/><br/>
